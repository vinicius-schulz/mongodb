...
//
//		groceryItemRepo.save(new GroceryItem(UUID.randomUUID(), "Whole Wheat Biscuit", 5, "snacks"));
//		groceryItemRepo.save(new GroceryItem(UUID.randomUUID(), "XYZ Kodo Millet healthy", 2, "millets"));
//		groceryItemRepo.save(new GroceryItem(UUID.randomUUID(), "Dried Whole Red Chilli", 2, "spices"));
//		groceryItemRepo.save(new GroceryItem(UUID.randomUUID(), "Healthy Pearl Millet", 1, "millets"));
//		groceryItemRepo.save(new GroceryItem(UUID.randomUUID(), "Bonny Cheese Crackers Plain", 6, "snacks"));
//
